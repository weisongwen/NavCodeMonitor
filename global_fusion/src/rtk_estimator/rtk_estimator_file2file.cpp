...
int main(int argc, char **argv)
{
	...
	double ti=10.0;						// processing interval  (s) (0:all)
	...
	prcopt.posopt[4] = 1;               // use RAIM FDE (qmo)
	...
	/* HK 20190428 harbour*/
	strcpy(infile[n++],"/home/wws/GraphGNSSLib/src/global_fusion/src/rtk_estimator/20190428/COM3_190428_124409.obs");
	strcpy(infile[n++],"/home/wws/GraphGNSSLib/src/global_fusion/src/rtk_estimator/20190428/hksc1180.19o");
	strcpy(infile[n++],"/home/wws/GraphGNSSLib/src/global_fusion/src/rtk_estimator/20190428/hksc1180.19n");
	strcpy(infile[n++],"/home/wws/GraphGNSSLib/src/global_fusion/src/rtk_estimator/20190428/hksc1180.19b");
	prcopt.rb[0] = -2414266.9200;			// base position for relative mode {x,y,z} (ecef) (m)
	prcopt.rb[1] = 5386768.9870;			// base position for relative mode {x,y,z} (ecef) (m)
	prcopt.rb[2] = 2407460.0310;			// base position for relative mode {x,y,z} (ecef) (m)
